    ...
    @if($organization === null)
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-8 text-center">
            <div class="flex flex-col items-center gap-3 text-slate-400">
                ...
                <p class="font-semibold text-slate-600 dark:text-slate-300">{{ __('No organization yet') }}</p>
                <p class="text-sm max-w-md">
                    {{ __('You must belong to an organization before you can connect it to the AlloCore Hub.') }}
                </p>
            </div>
        </div>
    @else
